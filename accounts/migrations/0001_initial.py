    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('information', models.CharField(blank=True, max_length=50, null=True, verbose_name='Информация')),
                ...
                ('gender', models.CharField(choices=[('Мужской', 'Мужской'), ('Женский', 'Женский')], default=1, max_length=50)),
